...
<body>
        ...
        <main class="row justify-content-center gx-0">
            ...
            <form action="../Actions/edit-user-adtion.php" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="row justify-content-center mb-3">
                    <div class="col-6">
                        <?php
                        if($user['photo']){
                        ?>
                            <img src="../Assets/images/<?=$user['photo']?>" alt="<?=$user['photo']?>" class="d-block mx-auto mb-2 edit-photo" style="width: 7em; height: 7em;">
                        <?php
                        }else{
                        ?>
                        ...
                        <input type="file" name="photo" id="" class="form-control mb-2" accept="image/*">
                    </div>
